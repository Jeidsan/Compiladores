...
public class Sintatico implements Constants
{
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError
    {
        if (currentToken == null)
        {
            ...
            currentToken = new Token(DOLLAR, "$", pos, previousToken.getLine());
        }
        ...
        else if (isTerminal(x))
        {
            ...
            {
                throw new SyntaticError(PARSER_ERROR[x], currentToken.getPosition(), currentToken.getLine(), currentToken.getLexeme());
            }
        }
